...
protected :
   ...
   void v_function_false (unsigned u_nb_arg);
   void v_function_floor (unsigned u_nb_arg, expression_result ** erpp_arg);
   void v_function_last (unsigned u_nb_arg);
   ...
   void v_function_position (unsigned u_nb_arg);
   ...
   void v_function_text (unsigned u_nb_arg);
   void v_function_translate(unsigned u_nb_arg, expression_result ** erpp_arg);
   void v_function_true (unsigned u_nb_arg);
