...
resources, you should use one tileset by layer, and use the same name
for both. For exemple, if your map is designed with the layers
\textit{ground} and \textit{objects}, you need to use a tileset for 
the ground tiles : ground.tsx, and another one for the objects tiles :
objects.tsx.
...
already gave the map path to iAtal thanks to the running options, %see chapter...
